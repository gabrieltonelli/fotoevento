...
export default function CreateEvent() {
    ...
    const skins = [
        ...
        { value: 'elegant-gold', label: 'Elegante Dorado', preview: 'bg-gradient-to-br from-amber-900 to-yellow-800' },
        { value: 'neon', label: 'Neon', preview: 'bg-gradient-to-br from-purple-900 to-pink-900' },
        { value: 'minimal', label: 'Minimalista', preview: 'bg-white' },
        { value: 'fiesta', label: 'Fiesta', preview: 'bg-gradient-to-br from-rose-600 to-orange-500' },
    ];
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                {skins.map(skin => (
                                    <button
                                        ...
                                        className={`rounded-xl border overflow-hidden transition-all ${form.skin === skin.value
                        ...
                        <div className="glass rounded-2xl p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm text-white/60 mb-1">Máx. fotos por evento</label>
                                <input
                                    type="number"
