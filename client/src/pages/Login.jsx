        ...
        <div className="min-h-screen flex items-center justify-center bg-dark-950 px-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="glass rounded-2xl p-8">
                    <h1 className="font-display text-2xl font-bold text-white text-center mb-2">Iniciar Sesión</h1>
                    <p className="text-white/40 text-center text-sm mb-6">Ingresá a tu cuenta para gestionar tus eventos</p>
